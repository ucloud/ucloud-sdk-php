...
class UpdateNATGWSnatpoolRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "UpdateNATGWSnatpool"]);
        $this->markRequired("Region");
        $this->markRequired("NATGWId");
        $this->markRequired("IsSnatpoolEnabled");
    }
    ...
    /**
     * IsSnatpoolEnabled: 开启，"enable"；关闭，"disable"；
     *
     * @return string|null
     */
