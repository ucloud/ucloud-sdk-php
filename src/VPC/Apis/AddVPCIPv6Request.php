...
class AddVPCIPv6Request extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "AddVPCIPv6"]);
    ...
    /**
     * OperatorName: 类型 BGP | Telecom | ChinaMobile | Unicom
     *
     * @return string|null
     */
    ...
    /**
     * IPv6NetworkType: Default--默认网段、Custom--客户自带
     *
     * @return string|null
     */
    public function getIPv6NetworkType()
    {
        return $this->get("IPv6NetworkType");
    }

    /**
     * IPv6NetworkType: Default--默认网段、Custom--客户自带
     *
     * @param string $iPv6NetworkType
     */
    public function setIPv6NetworkType($iPv6NetworkType)
    {
        $this->set("IPv6NetworkType", $iPv6NetworkType);
    }
