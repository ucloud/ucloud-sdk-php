...
class EnableUniEipDirectModeRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "EnableUniEipDirectMode"]);
        $this->markRequired("Region");
        $this->markRequired("ProjectId");
        $this->markRequired("VPCId");
        $this->markRequired("InterfaceId");
    }
    ...
    /**
     * EipDirectVersion: 枚举值：1-EIP网卡可见2-EIP直通默认为1
     *
     * @return integer|null
     */
