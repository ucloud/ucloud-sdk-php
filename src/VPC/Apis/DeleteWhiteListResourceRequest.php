...
class DeleteWhiteListResourceRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "DeleteWhiteListResource"]);
        $this->markRequired("Region");
        $this->markRequired("NATGWId");
        $this->markRequired("ResourceIds");
    }
