...
class DeleteVPCIntercomRequest extends Request
{
    ...
    /**
     * Region: 源VPC所在地域。 参见 [地域和可用区列表](https://docs.ucloud.cn/api/summary/regionlist)
     *
     * @return string|null
     */
    ...
    /**
     * ProjectId: 源VPC所在项目ID。不填写为默认项目，子帐号必须填写。 请参考[GetProjectList接口](https://docs.ucloud.cn/api/summary/get_project_list)
     *
     * @return string|null
     */
    ...
    /**
     * DstRegion: 目的VPC所在地域，默认为源VPC所在地域
     *
     * @return string|null
     */
    ...
    /**
     * DstProjectId: 目的VPC所在项目ID，默认为源VPC所在项目ID
     *
     * @return string|null
     */
