...
class SecGroupResourceInfo extends Response
{
    ...
    /**
     * SubResourceType: 绑定的虚拟网卡的类型，“uni”，虚拟网卡
     *
     * @return string|null
     */
    ...
    /**
     * ResourceType: 资源类型。"unatgw"，NAT网关； "uhost"，云主机； "upm"，物理云主机； "hadoophost"，hadoop节点； "fortresshost"，堡垒机； "udhost"，私有专区主机；"udockhost"，容器；"dbaudit"，数据库审计，“uni”，虚拟网卡。
     *
     * @return string|null
     */
