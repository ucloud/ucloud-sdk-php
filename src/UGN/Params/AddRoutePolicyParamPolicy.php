...
class AddRoutePolicyParamPolicy extends Request
{
     ...
     * SrcNetworks:
     *
     * @return AddRoutePolicyParamPolicySrcNetworks[]|null
     */
    public function getSrcNetworks()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new AddRoutePolicyParamPolicySrcNetworks($item));
        }
        return $result;
    }
     ...
     * SrcNetworks:
     *
     * @param AddRoutePolicyParamPolicySrcNetworks[] $srcNetworks
     */
    ...
    /**
     * DstNetworkTypes: 路由策略需要作用的网络实例类型数组，限定取值："VPC" / "UWAN-VRouter"，"Direction" 为 "In" 时，该值无效
     *
     * @return string[]|null
     */
     ...
     * DstNetworks:
     *
     * @return AddRoutePolicyParamPolicyDstNetworks[]|null
     */
    public function getDstNetworks()
    {
        ...
        $result = [];
        foreach ($items as $i => $item) {
            array_push($result, new AddRoutePolicyParamPolicyDstNetworks($item));
        }
        return $result;
    }
     ...
     * DstNetworks:
     *
     * @param AddRoutePolicyParamPolicyDstNetworks[] $dstNetworks
     */
