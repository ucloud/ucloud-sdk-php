...
class BackupUMongoDBLogRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "BackupUMongoDBLog"]);
