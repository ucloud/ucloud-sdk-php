...
use UCloud\ULogService\Params\CreateULogServiceCollectConfParamFilePaths;

class CreateULogServiceCollectConfRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "CreateULogServiceCollectConf"]);
     ...
     * FilePaths:
     *
     * @return CreateULogServiceCollectConfParamFilePaths[]|null
     */
    public function getFilePaths()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new CreateULogServiceCollectConfParamFilePaths($item));
        }
        return $result;
    }
     ...
     * FilePaths:
     *
     * @param CreateULogServiceCollectConfParamFilePaths[] $filePaths
     */
