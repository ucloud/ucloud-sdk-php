...
class UseCases extends Response
{
     ...
     * @return string|null
     */
    public function getClusterCase()
    {
        return $this->get("ClusterCase");
    }

    /**
     * ClusterCase: 集群种类
     *
     * @param string $clusterCase
     */
    public function setClusterCase($clusterCase)
    {
        $this->set("ClusterCase", $clusterCase);
    }
