...
class UpgradeUHadoopNodeRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "UpgradeUHadoopNode"]);
    ...
    /**
     * NodeRole: 节点角色，支持"master"|"core"|"task"
     *
     * @return string|null
     */
    ...
    /**
     * NodeType: 节点新机型，通过GetUHadoopNodeType接口获取
     *
     * @return string|null
     */
    ...
    /**
     * NodeNames: 节点名称，当NodeRole不为master时必填
     *
     * @return string[]|null
     */
