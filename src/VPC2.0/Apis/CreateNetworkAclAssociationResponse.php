...
class CreateNetworkAclAssociationResponse extends Response
{
    ...
    {
        return new AssociationInfoModel($this->get("PrevAssociation"));
    }

    /**
     * PrevAssociation: 该子网之前的绑定关系信息
     *
     * @param AssociationInfoModel $prevAssociation
     */
    public function setPrevAssociation(AssociationInfoModel $prevAssociation)
    {
