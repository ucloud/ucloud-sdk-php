...
use UCloud\VPC\Models\DescribeVPCResponse;
...
class VPCInfo extends Response
{
     ...
     * NetworkInfo:
     *
     * @return VPCNetworkInfoModel[]|null
     */
    public function getNetworkInfo()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new VPCNetworkInfoModel($item));
        }
        return $result;
    }
     ...
     * NetworkInfo:
     *
     * @param VPCNetworkInfoModel[] $networkInfo
     */
