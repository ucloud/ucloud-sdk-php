...
use UCloud\VPC\Models\DescribeNATGWResponse;
...
class NatGatewayDataSet extends Response
{
     ...
     * SubnetSet: 子网 Id
     *
     * @return NatGatewaySubnetSetModel[]|null
     */
    public function getSubnetSet()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new NatGatewaySubnetSetModel($item));
        }
        return $result;
    }
     ...
     * SubnetSet: 子网 Id
     *
     * @param NatGatewaySubnetSetModel[] $subnetSet
     */
     ...
     * IPSet: 绑定的EIP 信息
     *
     * @return NatGatewayIPSetModel[]|null
     */
    public function getIPSet()
    {
        ...
        $result = [];
        foreach ($items as $i => $item) {
            array_push($result, new NatGatewayIPSetModel($item));
        }
        return $result;
    }
     ...
     * IPSet: 绑定的EIP 信息
     *
     * @param NatGatewayIPSetModel[] $ipSet
     */
