...
use UCloud\VPC\Models\DescribeNetworkAclEntryResponse;
...
class AclEntryInfo extends Response
{
     ...
     *
     * @return TargetResourceInfoModel[]|null
     */
    public function getTargetResourceList()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new TargetResourceInfoModel($item));
        }
        return $result;
    }
     ...
     * TargetResourceList: 应用目标资源信息。TargetType为0时不返回该值。具体结构见下方TargetResourceInfo
     *
     * @param TargetResourceInfoModel[] $targetResourceList
     */
