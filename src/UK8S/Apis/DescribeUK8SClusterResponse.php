...
class DescribeUK8SClusterResponse extends Response
{
    ...
    public function getMasterList()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new UhostInfoModel($item));
        }
        return $result;
    }
     ...
     * MasterList: Master节点配置信息，具体参考UhostInfo。托管版不返回该信息
     *
     * @param UhostInfoModel[] $masterList
     */
    ...
    {
        return new Model($this->get("KubeProxy"));
    }

    /**
     * KubeProxy: kube-proxy配置
     *
     * @param Model $kubeProxy
     */
    public function setKubeProxy(Model $kubeProxy)
    {
