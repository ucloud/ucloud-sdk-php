...
class UhostInfo extends Response
{
    ...
    public function getIPSet()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new IPSetModel($item));
        }
        return $result;
    }
    ...
    public function getDiskSet()
    {
        ...
        $result = [];
        foreach ($items as $i => $item) {
            array_push($result, new DiskSetModel($item));
        }
        return $result;
    }
