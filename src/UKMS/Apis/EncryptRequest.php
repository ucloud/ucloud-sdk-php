...
use UCloud\UKMS\Params\EncryptParamEncryptionContext;
...
class EncryptRequest extends Request
{
     ...
     *
     * @return EncryptParamEncryptionContext|null
     */
    public function getEncryptionContext()
    {
        return new EncryptParamEncryptionContext($this->get("EncryptionContext"));
    }

    /**
     * EncryptionContext: 加密上下文，JSON Object。
     *
     * @param EncryptParamEncryptionContext $encryptionContext
     */
