...
use UCloud\UKMS\Params\GenerateDataKeyParamEncryptionContext;
...
class GenerateDataKeyRequest extends Request
{
     ...
     *
     * @return GenerateDataKeyParamEncryptionContext|null
     */
    public function getEncryptionContext()
    {
        return new GenerateDataKeyParamEncryptionContext($this->get("EncryptionContext"));
    }

    /**
     * EncryptionContext: 加密上下文，JSON Object。
     *
     * @param GenerateDataKeyParamEncryptionContext $encryptionContext
     */
