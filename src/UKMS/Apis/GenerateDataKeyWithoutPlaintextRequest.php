...
use UCloud\UKMS\Params\GenerateDataKeyWithoutPlaintextParamEncryptionContext;

class GenerateDataKeyWithoutPlaintextRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "GenerateDataKeyWithoutPlaintext"]);
     ...
     *
     * @return GenerateDataKeyWithoutPlaintextParamEncryptionContext|null
     */
    public function getEncryptionContext()
    {
        return new GenerateDataKeyWithoutPlaintextParamEncryptionContext($this->get("EncryptionContext"));
    }

    /**
     * EncryptionContext: 加密上下文，JSON Object。
     *
     * @param GenerateDataKeyWithoutPlaintextParamEncryptionContext $encryptionContext
     */
