...
class SignRequest extends Request
{
    ...
    {
        parent::__construct(["Action" => "Sign"]);
    ...
    /**
     * SigningMessage: 待签名消息，Base64 编码，最大 4096 字节。
     *
     * @return string|null
     */
    ...
    /**
     * SigningAlgorithm: 签名算法。可选值：RSASSA_PSS_SHA_256、RSASSA_PSS_SHA_384、RSASSA_PSS_SHA_512、RSASSA_PKCS1_V1_5_SHA_256、RSASSA_PKCS1_V1_5_SHA_384、RSASSA_PKCS1_V1_5_SHA_512、ECDSA_SHA_256、ECDSA_SHA_384、ECDSA_SHA_512；须与密钥 KeySpec 匹配。
     *
     * @return string|null
     */
