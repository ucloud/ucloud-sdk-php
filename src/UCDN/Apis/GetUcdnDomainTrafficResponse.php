...
use UCloud\UCDN\Models\UcdnDomainTrafficSet;

class GetUcdnDomainTrafficResponse extends Response
{
    

    /**
     * TrafficSet: 流量实例表，具体结构见 UcdnDomainTrafficSet
     *
     ...
     * TrafficSet: 流量实例表，具体结构见 UcdnDomainTrafficSet
     *
     * @param UcdnDomainTrafficSet[] $trafficSet
     */
