...
class UnpaidOrderItem extends Response
{
     ...
     */
    public function setSourceOrderNo($sourceOrderNo)
    {
        $this->set("SourceOrderNo", $sourceOrderNo);
    }
    ...
    /**
     * ResourceTypeDisplay: 资源类型显示名
     *
     * @return string|null
     */
    public function getResourceTypeDisplay()
    {
        return $this->get("ResourceTypeDisplay");
    }

    /**
     * ResourceTypeDisplay: 资源类型显示名
     *
     * @param string $resourceTypeDisplay
     */
    public function setResourceTypeDisplay($resourceTypeDisplay)
    {
        $this->set("ResourceTypeDisplay", $resourceTypeDisplay);
    }
    ...
    /**
     * RevocationTime: 撤销时间（Unix 时间戳，秒级）
     *
     * @return string|null
     */
    public function getRevocationTime()
    {
        return $this->get("RevocationTime");
    }
    ...
    {
        $this->set("RevocationTime", $revocationTime);
    }
