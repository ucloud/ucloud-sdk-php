...
class UFSClient extends Client
{
     ...
     */
    public function addUFSVolumeMountPoint(AddUFSVolumeMountPointRequest $request = null): AddUFSVolumeMountPointResponse
    {
     ...
     * @throws UCloudException
     */
    public function describeUFSVolumeMountpoint(DescribeUFSVolumeMountpointRequest $request = null): DescribeUFSVolumeMountpointResponse
    {
        $resp = $this->invoke($request);
     ...
     * @throws UCloudException
     */
    public function describeUFSVolumePrice(DescribeUFSVolumePriceRequest $request = null): DescribeUFSVolumePriceResponse
    {
        $resp = $this->invoke($request);
     ...
     * @throws UCloudException
     */
    public function removeUFSVolumeMountPoint(RemoveUFSVolumeMountPointRequest $request = null): RemoveUFSVolumeMountPointResponse
    {
        $resp = $this->invoke($request);
     ...
     * @throws UCloudException
     */
    public function updateUFSVolumeInfo(UpdateUFSVolumeInfoRequest $request = null): UpdateUFSVolumeInfoResponse
    {
        $resp = $this->invoke($request);
