...
class DescribeVPNGatewayRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "DescribeVPNGateway"]);
     ...
     * @return string[]|null
     */
    public function getVPNGatewayIds(): array
    {
        return $this->get("VPNGatewayIds");
    }

    /**
     * VPNGatewayIds: VPN网关的资源ID，例如VPNGatewayIds.0代表希望获取VPN网关1的信息，VPNGatewayIds.1代表VPN网关2，如果为空，则返回当前Region中所有VPN网关的信息
     *
     * @param string[] $vpnGatewayIds
     */
    public function setVPNGatewayIds(array $vpnGatewayIds)
    {
