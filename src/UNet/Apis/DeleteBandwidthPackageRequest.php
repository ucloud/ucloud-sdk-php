...
class DeleteBandwidthPackageRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "DeleteBandwidthPackage"]);
        $this->markRequired("Region");
        $this->markRequired("BandwidthPackageId");
    }
