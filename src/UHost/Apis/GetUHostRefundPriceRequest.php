...
class GetUHostRefundPriceRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "GetUHostRefundPrice"]);
    ...
    /**
     * UHostIds: 【数组】UHost实例ID。参见 [DescribeUHostInstance](describe_uhost_instance.html)
     *
     * @return string[]|null
     */
