...
class FamiliesDisks extends Response
{
     ...
     * BootDisk: 系统盘信息
     *
     * @return FamiliesBootDiskInfo[]|null
     */
    public function getBootDisk()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new FamiliesBootDiskInfo($item));
        }
        return $result;
    }
     ...
     * BootDisk: 系统盘信息
     *
     * @param FamiliesBootDiskInfo[] $bootDisk
     */
     ...
     * DataDisk: 数据盘信息
     *
     * @return FamiliesDataDiskInfo[]|null
     */
    public function getDataDisk()
    {
        ...
        $result = [];
        foreach ($items as $i => $item) {
            array_push($result, new FamiliesDataDiskInfo($item));
        }
        return $result;
    }
     ...
     * DataDisk: 数据盘信息
     *
     * @param FamiliesDataDiskInfo[] $dataDisk
     */
