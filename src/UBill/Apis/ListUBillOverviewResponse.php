...
class ListUBillOverviewResponse extends Response
{
     ...
     */
    public function setTotalPaidAmountReal(string $totalPaidAmountReal)
    {
     ...
     */
    public function setTotalUnpaidAmount(string $totalUnpaidAmount)
    {
     ...
     * Items: 账单聚合数据
     *
     * @return BillOverviewItemModel[]|null
     */
    public function getItems()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new BillOverviewItemModel($item));
        }
        return $result;
    }
     ...
     * Items: 账单聚合数据
     *
     * @param BillOverviewItemModel[] $items
     */
