...
class BillDetailItem extends Response
{
    ...
    public function getItemDetails()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new ItemDetailModel($item));
        }
        return $result;
    }
     ...
     * ItemDetails: 产品配置
     *
     * @param ItemDetailModel[] $itemDetails
     */
     ...
     *
     * @return ResourceExtendInfoModel[]|null
     */
    public function getResourceExtendInfo()
    {
        ...
        $result = [];
        foreach ($items as $i => $item) {
            array_push($result, new ResourceExtendInfoModel($item));
        }
        return $result;
    }
     ...
     * ResourceExtendInfo: 资源标识
     *
     * @param ResourceExtendInfoModel[] $resourceExtendInfo
     */
