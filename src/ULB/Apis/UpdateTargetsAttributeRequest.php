...
use UCloud\ULB\Params\UpdateTargetsAttributeParamTargets;

class UpdateTargetsAttributeRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "UpdateTargetsAttribute"]);
     ...
     * Targets:
     *
     * @return UpdateTargetsAttributeParamTargets[]|null
     */
    public function getTargets()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new UpdateTargetsAttributeParamTargets($item));
        }
        return $result;
    }
     ...
     * Targets:
     *
     * @param UpdateTargetsAttributeParamTargets[] $targets
     */
