...
class UpdateSecurityPolicyRequest extends Request
{
    ...
    {
        parent::__construct(["Action" => "UpdateSecurityPolicy"]);
        $this->markRequired("Region");
        $this->markRequired("ProjectId");
        $this->markRequired("SecurityPolicyId");
    }
    ...
    /**
     * SSLCiphers: 加密套件，TLS最低版本和加密套件必须全不为空或全为空
     *
     * @return string[]|null
     */
    ...
    /**
     * TLSVersion: TLS最低版本，TLS最低版本和加密套件必须全不为空或全为空
     *
     * @return string|null
     */
