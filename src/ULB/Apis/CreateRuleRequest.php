...
use UCloud\ULB\Params\CreateRuleParamRuleConditions;
use UCloud\ULB\Params\CreateRuleParamRuleConditionsHostConfig;
use UCloud\ULB\Params\CreateRuleParamRuleConditionsPathConfig;
use UCloud\ULB\Params\CreateRuleParamRuleActions;
use UCloud\ULB\Params\CreateRuleParamRuleActionsForwardConfig;
use UCloud\ULB\Params\CreateRuleParamRuleActionsForwardConfigTargets;
use UCloud\ULB\Params\CreateRuleParamRuleActionsInsertHeaderConfig;
...
class CreateRuleRequest extends Request
{
    ...
    {
        parent::__construct(["Action" => "CreateRule"]);
     ...
     * RuleConditions:
     *
     * @return CreateRuleParamRuleConditions[]|null
     */
    public function getRuleConditions()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new CreateRuleParamRuleConditions($item));
        }
        return $result;
    }
     ...
     * RuleConditions:
     *
     * @param CreateRuleParamRuleConditions[] $ruleConditions
     */
     ...
     * RuleActions:
     *
     * @return CreateRuleParamRuleActions[]|null
     */
    public function getRuleActions()
    {
        ...
        $result = [];
        foreach ($items as $i => $item) {
            array_push($result, new CreateRuleParamRuleActions($item));
        }
        return $result;
    }
     ...
     * RuleActions:
     *
     * @param CreateRuleParamRuleActions[] $ruleActions
     */
    ...
    /**
     * Pass: 当转发的服务节点为空时，规则是否忽略。默认值true
     *
     * @return boolean|null
     */
