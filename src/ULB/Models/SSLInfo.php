...
class SSLInfo extends Response
{
    ...
    /**
     * Relations: SSL绑定ULB和ALB的关系
     *
     * @return SSLRelation[]|null
     */
    public function getRelations()
    {
        $items = $this->get("Relations");
        if ($items == null) {
            return [];
        }
        $result = [];
        foreach ($items as $i => $item) {
            array_push($result, new SSLRelation($item));
        }
        return $result;
    }
