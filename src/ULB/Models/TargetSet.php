...
class TargetSet extends Response
{
    ...
    /**
     * Port: 服务节点的端口。限定取值：[1-65535]； 默认值：80
     *
     * @return integer|null
     */
    ...
    /**
     * Weight: 服务节点的权重。限定取值：[1-100]； 仅在加权轮询算法时有效； 默认值：1
     *
     * @return integer|null
     */
