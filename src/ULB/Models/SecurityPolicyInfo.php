...
class SecurityPolicyInfo extends Response
{
     ...
     * Relations: 关联的监听
     *
     * @return SecurityPolicyRelation[]|null
     */
    public function getRelations()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new SecurityPolicyRelation($item));
        }
        return $result;
    }
     ...
     * Relations: 关联的监听
     *
     * @param SecurityPolicyRelation[] $relations
     */
