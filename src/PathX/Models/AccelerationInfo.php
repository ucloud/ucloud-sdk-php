...
class AccelerationInfo extends Response
{
     ...
     */
    public function setAccelerationName(string $accelerationName)
    {
    ...
    public function getNodeInfo()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new NodeDelaysModel($item));
        }
        return $result;
    }
     ...
     * NodeInfo: 加速提升情况
     *
     * @param NodeDelaysModel[] $nodeInfo
     */
