...
class ForwardInfo extends Response
{
     ...
     *
     * @return AccelerationAreaInfosModel[]|null
     */
    public function getAccelerationAreaInfos()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new AccelerationAreaInfosModel($item));
        }
        return $result;
    }
     ...
     * AccelerationAreaInfos: 加速节点列表
     *
     * @param AccelerationAreaInfosModel[] $accelerationAreaInfos
     */
     ...
     * EgressIpList: 回源出口IP地址
     *
     * @param OutPublicIpInfoModel[] $egressIpList
     */
    ...
    public function getPortSets()
    {
        ...
        $result = [];
        foreach ($items as $i => $item) {
            array_push($result, new ForwardTaskModel($item));
        }
        return $result;
    }
     ...
     * PortSets: 端口列表
     *
     * @param ForwardTaskModel[] $portSets
     */
