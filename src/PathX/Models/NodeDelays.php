...
class NodeDelays extends Response
{
     ...
     * @return float|null
     */
    public function getLatencyInternet(): float
    {
     ...
     */
    public function setLatencyInternet(float $latencyInternet)
    {
     ...
     * @return float|null
     */
    public function getLatencyOptimization(): float
    {
     ...
     */
    public function setLatencyOptimization(float $latencyOptimization)
    {
     ...
     * @return float|null
     */
    public function getLossInternet(): float
    {
     ...
     */
    public function setLossInternet(float $lossInternet)
    {
     ...
     * @return float|null
     */
    public function getLossOptimization(): float
    {
     ...
     */
    public function setLossOptimization(float $lossOptimization)
    {
