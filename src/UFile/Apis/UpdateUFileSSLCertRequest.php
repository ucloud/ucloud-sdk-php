...
class UpdateUFileSSLCertRequest extends Request
{
    public function __construct()
    {
        parent::__construct(["Action" => "UpdateUFileSSLCert"]);
        $this->markRequired("BucketName");
        $this->markRequired("Domain");
        $this->markRequired("CertificateName");
        $this->markRequired("Certificate");
        $this->markRequired("CertificateKey");
    }
