...
class BucketMonthlyBills extends Response
{
     ...
     *
     * @return UFileMonthlyBillItem[]|null
     */
    public function getBucketBills()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new UFileMonthlyBillItem($item));
        }
        return $result;
    }
     ...
     * BucketBills: bucket账单
     *
     * @param UFileMonthlyBillItem[] $bucketBills
     */
