...
class CreateAlertStrategyParamRuleSet extends Request
{
    ...
    /**
     * ThresholdCompare: 阈值比较方式。 枚举值：1：>= 2：<= 3：> 4：< 5：== 6：!=
     *
     * @return integer|null
     */
    ...
    /**
     * SendPeriodType: 触发周期。枚举值continuous - 连续exponent - 指数single - 不重复
     *
     * @return string|null
     */
    ...
    /**
     * SendInterval: 沉默周期(告警周期选择为连续时必填)
     *
     * @return integer|null
     */
